...
ReactElement TabsExample() {
  ...
  return <div className="tabs-container">
    ...
    <div className="tab-buttons">
      <button
        className={activeTab.value == 'home' ? 'tab-btn active' : 'tab-btn'}
        onClick={() => activeTab.set('home')}
      >
        Home
      </button>
      <button
        className={activeTab.value == 'profile' ? 'tab-btn active' : 'tab-btn'}
        onClick={() => activeTab.set('profile')}
      >
        Profile
      </button>
      <button
        className={activeTab.value == 'settings' ? 'tab-btn active' : 'tab-btn'}
